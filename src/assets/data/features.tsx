export const features = {
  key: [
    <>
      Play <strong>SNES</strong> games (.sfc, .smc).
    </>,
    "Zip and 7z ROM formats are also supported.",
    <>
      Powered by <strong>Retroarch</strong>, and several cores (
  ...
  other: [
    ...
    <>
      Compatible with{" "}
      <a href="https://retroflag.com/SUPERPi-CASE-J.html" target="_blank">
        Retroflag's SuperPi U and J
      </a>{" "}
